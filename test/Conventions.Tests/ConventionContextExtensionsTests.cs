...
namespace Rocket.Surgery.Conventions.Tests
{
    public class ConventionContextExtensionsTests
    {
        ...
        {
            var context = A.Fake<IConventionContext>();
            A.CallTo(() => context[typeof(HostType)]).Returns(HostType.TestHost);

            context.IsTestHost().Should().BeTrue();
        }
        ...
        {
            var context = A.Fake<IConventionContext>();
            A.CallTo(() => context[typeof(HostType)]).Returns(HostType.Default);

            context.IsTestHost().Should().BeFalse();
        }
