...
/// </summary>
internal class LocalWebAssemblyHostBuilder : IWebAssemblyHostBuilder
{
    ...
    internal LocalWebAssemblyHostBuilder()
    {
        ...
        _createServiceProvider = () => { return Services.BuildServiceProvider(hostEnvironment.IsDevelopment()); };
    }
