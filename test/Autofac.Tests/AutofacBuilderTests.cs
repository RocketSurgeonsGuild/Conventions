...
public class AutofacBuilderTests : AutoFakeTest<LocalTestContext>
{
    [Fact]
    ...
    public AutofacBuilderTests(ITestOutputHelper outputHelper) : base(LocalTestContext.Create(outputHelper))
    {
