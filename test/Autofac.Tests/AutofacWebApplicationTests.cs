...
public class AutofacWebApplicationTests : AutoFakeTest<LocalTestContext>
{
    [Fact]
    ...
    public AutofacWebApplicationTests(ITestOutputHelper outputHelper) : base(LocalTestContext.Create(outputHelper))
    {
