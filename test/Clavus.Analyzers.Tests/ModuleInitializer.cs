...
public static class ModuleInitializer
{
    ...
    public static void Init()
    {
        ...
        VerifierSettings.AddScrubber(
            (builder, counter) =>
            {
                if (typeof(ClavusAttributesGenerator).Assembly.GetCustomAttribute<AssemblyFileVersionAttribute>() is { Version: { Length: > 0, } version, })
                    builder.Replace(version, "version");
                if (typeof(ClavusAttributesGenerator).Assembly.GetCustomAttribute<AssemblyVersionAttribute>() is { Version: { Length: > 0, } version2, })
