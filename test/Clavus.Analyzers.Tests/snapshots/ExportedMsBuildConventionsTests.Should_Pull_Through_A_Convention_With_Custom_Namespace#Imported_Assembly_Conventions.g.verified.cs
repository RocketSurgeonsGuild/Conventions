...
[assembly: System.Reflection.AssemblyMetadata("Clavus.Import.Namespace", "ExportedMsBuildConventions")]
...
namespace ExportedMsBuildConventions
{
    /// <summary>
    ...
    internal static partial class Imports
    {
        ...
        private static IEnumerable<IClavusPartMetadata> LoadClavusPartsMethod()
        {
            ...
            foreach (var part in SampleDependencyThree.Conventions.Exports.Ashlar())
                yield return part;
            foreach (var part in Source.Space.SourceClass.Ashlar())
                yield return part;
        }
    };
}
