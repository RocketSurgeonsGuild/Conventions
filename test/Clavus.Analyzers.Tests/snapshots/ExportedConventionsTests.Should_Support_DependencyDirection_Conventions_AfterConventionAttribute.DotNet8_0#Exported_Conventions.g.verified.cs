...
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new Rocket.Surgery.Clavus.Tests.Contrib(), HostType.Live, ClavusCategory.Application).WithDependency(DependencyDirection.DependsOn, typeof(Rocket.Surgery.Clavus.Tests.D));
        }
    }
}
