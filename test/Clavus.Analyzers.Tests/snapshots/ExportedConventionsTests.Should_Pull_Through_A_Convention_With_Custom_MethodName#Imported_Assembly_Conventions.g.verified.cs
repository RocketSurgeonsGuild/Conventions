...
[assembly: System.Reflection.AssemblyMetadata("Rocket.Surgery.ClavusConfigurationData.Imports.Namespace", "TestProject.Conventions")]
[assembly: System.Reflection.AssemblyMetadata("Rocket.Surgery.ClavusConfigurationData.Imports.ClassName", "Imports")]
    ...
    internal static partial class Imports
    {
        ...
        private static IEnumerable<IClavusPartMetadata> LoadConventionsMethod(ClavusContextBuilder builder)
        {
            ...
            foreach (var convention in SampleDependencyThree.Conventions.Exports.GetConventions(builder))
                yield return convention;
            foreach (var convention in TestProject.Conventions.Exports.SourceMethod(builder))
                yield return convention;
        }
    };
}
