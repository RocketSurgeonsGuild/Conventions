...
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new Clavus.Tests.Contrib(), HostType.Live, ClavusCategory.Application).WithDependency(DependencyDirection.DependentOf, typeof(Clavus.Tests.D));
        }
    }
}
