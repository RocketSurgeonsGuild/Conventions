...
[assembly: ExportedClavusParts(typeof(TestProject.Program))]
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new TestProject.Program(), HostType.Undefined, ClavusCategory.Application);
        }
    }
}
