...
[assembly: ExportedConventions(typeof(Rocket.Surgery.Clavus.Tests.ParentContrib.Contrib))]
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new Rocket.Surgery.Clavus.Tests.ParentContrib.Contrib(builder.Properties.GetService<Rocket.Surgery.Clavus.Tests.IService>(), builder.Properties.GetService<Rocket.Surgery.Clavus.Tests.IServiceB>(), builder.Properties.GetService<Rocket.Surgery.Clavus.Tests.IServiceC>()), HostType.Undefined, ClavusCategory.Application);
        }
    }
}
