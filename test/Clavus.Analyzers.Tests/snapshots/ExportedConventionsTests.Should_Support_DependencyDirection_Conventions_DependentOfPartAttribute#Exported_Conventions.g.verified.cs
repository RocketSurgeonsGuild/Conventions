...
public static partial class Exports
{
    ...
    {
        yield return new ClavusPartMetadata(new Clavus.Tests.Contrib(), HostType.Undefined, ClavusCategory.Application).WithDependency(DependencyDirection.DependentOf, typeof(Clavus.Tests.D));
    }
}
