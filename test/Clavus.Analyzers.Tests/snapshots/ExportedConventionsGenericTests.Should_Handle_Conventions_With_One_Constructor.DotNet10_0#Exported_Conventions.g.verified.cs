...
[assembly: ExportedConventions(typeof(Clavus.Tests.ParentContrib.Contrib))]
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new Clavus.Tests.ParentContrib.Contrib(builder.Properties.GetService<Clavus.Tests.IService>(), builder.Properties.GetService<Clavus.Tests.IServiceB>(), builder.Properties.GetService<Clavus.Tests.IServiceC>()), HostType.Undefined, ClavusCategory.Application);
        }
    }
}
