...
[assembly: ExportedClavusParts(typeof(Rocket.Surgery.LaunchPad.Mapping.AutoMapperConvention))]
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ClavusPartMetadata(new Rocket.Surgery.LaunchPad.Mapping.AutoMapperConvention(builder.Properties.GetService<Rocket.Surgery.LaunchPad.Mapping.AutoMapperOptions>()), HostType.Undefined, ClavusCategory.Application);
        }
    }
}
