...
[assembly: System.Reflection.AssemblyMetadata("Clavus.Import.Namespace", "Sample")]
...
namespace Sample
{
    ...
    internal static partial class Imports
    {
        ...
        {
            foreach (var part in Clavus.Configuration.Toml.Tectum.Exports.Ashlar())
                yield return part;
            foreach (var part in Clavus.Configuration.Yaml.Tectum.Exports.Ashlar())
                yield return part;
        }
    };
}
