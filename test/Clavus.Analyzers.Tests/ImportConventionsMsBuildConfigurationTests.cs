...
public class ImportConventionsMsBuildConfigurationTests() : GeneratorTest()
{
    ...
    public async Task Should_Generate_Static_Assembly_Level_Method()
    {
        var result = await WithSharedDeps()
                          .AddGlobalOption("build_property.ImportClavusAssembly", "true")
                          .Build()
    ...
    {
        var result = await WithSharedDeps()
                          .AddGlobalOption("build_property.ImportClavusAssembly", "false")
                          .Build()
                          .GenerateAsync(TestContext.CancellationToken);
    ...
    {
        var result = await WithSharedDeps()
                          .AddGlobalOption("build_property.ImportClavusNamespace", "Test.My.Namespace")
                          .AddGlobalOption("build_property.ImportClavusClassName", "MyImports")
                          .Build()
                          .GenerateAsync(TestContext.CancellationToken);
    ...
    {
        var result = await WithSharedDeps()
                          .AddGlobalOption("build_property.ImportClavusNamespace", "")
                          .AddGlobalOption("build_property.ImportClavusClassName", "MyImports")
                          .Build()
                          .GenerateAsync(TestContext.CancellationToken);
    ...
    public async Task Should_Generate_Static_Assembly_Level_Method_Custom_MethodName()
    {
        var result = await WithSharedDeps()
                          .AddGlobalOption("build_property.ImportClavusNamespace", "Test.My.Namespace")
                          .AddGlobalOption("build_property.ImportClavusClassName", "MyImports")
                          .AddGlobalOption("build_property.ImportClavusMethodName", "ImportConventions")
                          .Build()
                          .GenerateAsync(TestContext.CancellationToken);
...
"
                          ...
                          .AddGlobalOption("build_property.ImportClavusMethodName", "ImportsConventions")
                          .Build()
                          .GenerateAsync(TestContext.CancellationToken);
