...
namespace TestProject.Conventions
{
    ...
    file class AssemblyProvider(AssemblyLoadContext context) : IAssemblyProvider
    {
        ...
        IEnumerable<Type> IAssemblyProvider.GetTypes(Func<ITypeProviderAssemblySelector, IEnumerable<Type>> selector, int lineNumber, string filePath, string argumentExpression)
        {
            switch (lineNumber)
            {
                // FilePath: Input0.cs Expression: eoGHCOpN1CRv8ZCXlI75+A==
                case 18:
                    yield return RocketSurgeryConventionsAbstractions.GetType("Rocket.Surgery.Conventions.<IAssemblyProvider>F742B48AECD3090FCED73F7295C987403C958108A026334C95957DD29503853D0__AP");
