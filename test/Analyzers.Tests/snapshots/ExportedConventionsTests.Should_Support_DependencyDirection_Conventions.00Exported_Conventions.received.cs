...
namespace TestProject.Conventions
{
    ...
    public static partial class Exports
    {
        ...
        {
            yield return new ConventionWithDependencies(new Rocket.Surgery.Conventions.Tests.Contrib(), HostType.Live).WithDependency(DependencyDirection.DependentOf, typeof(Rocket.Surgery.Conventions.Tests.D));
        }
    }
}