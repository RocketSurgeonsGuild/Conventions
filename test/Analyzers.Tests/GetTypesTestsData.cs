...
public class GetTypesTestsData
{
    ...
    public static IEnumerable<object[]> GetTypesData()
    {
        ...
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.Contains("Convention").NotKindOf(TypeKindFilter.Delegate, TypeKindFilter.Class, TypeKindFilter.Enum)));
        ...
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.Abstract).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.Visible).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.ValueType).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
//        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.Nested).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.Sealed).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.GenericType).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
//        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.InfoOf(TypeInfoFilter.GenericTypeDefinition).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.Abstract).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.Visible).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.ValueType).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
//        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.Nested).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.Sealed).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
        yield return TestMethod(z => z.FromAssemblyOf<IConvention>().GetTypes(x => x.NotInfoOf(TypeInfoFilter.GenericType).NotAssignableTo<Attribute>().NotInNamespaces("JetBrains.Annotations")));
