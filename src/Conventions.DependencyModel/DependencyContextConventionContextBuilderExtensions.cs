...
namespace Rocket.Surgery.Conventions
{
    ...
    {
        internal static IAssemblyCandidateFinder dependencyContextAssemblyCandidateFinderFactory(object? source, ILogger? logger) => source switch
        {
        ...
        internal static IAssemblyProvider dependencyContextAssemblyProviderFactory(object? source, ILogger? logger) => source switch
        {
        ...
        /// <returns></returns>
        public static ConventionContextBuilder UseDependencyContext(this ConventionContextBuilder builder, [NotNull] DependencyContext dependencyContext)
        {
