...
namespace Rocket.Surgery.Conventions
{
    ...
    public abstract class
        ConventionComposer<TContext, TContribution, TDelegate> : IConventionComposer<TContext, TContribution, TDelegate>
    ...
    public class ConventionComposer : IConventionComposer
    {
        ...
        /// <see cref="IConventionContext" />, or a type that implements
        /// <see cref="IConvention{T}" />
        /// </param>
        /// <inheritdoc />
