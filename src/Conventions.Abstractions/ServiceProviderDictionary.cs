...
public class ServiceProviderDictionary : IServiceProviderDictionary, IReadOnlyServiceProviderDictionary
{
    ...
    public ServiceProviderDictionary(PropertiesType? values) => _values = values ?? new PropertiesDictionary();

    /// <summary>
    ///     Initializes a new instance of the <see cref="ServiceProviderDictionary" /> class.
    /// </summary>
    public ServiceProviderDictionary() => _values = new PropertiesDictionary();
    ...
    public void Add(KeyValuePair<object, object> item) => _values.Add(item.Key, item.Value);
    ...
    public void CopyTo(KeyValuePair<object, object>[] array, int arrayIndex) => _values.CopyTo(array, arrayIndex);
