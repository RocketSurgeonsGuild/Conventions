...
/// <summary>
///     An attribute that ensures the convention runs after the given <see cref="IClavusPart" />
/// </summary>
...
public sealed class DependsOnPartAttribute(
    ...
    ) : Attribute, IClavusDependency
{
    ...
    DependencyDirection IClavusDependency.Direction => DependencyDirection.DependsOn;
