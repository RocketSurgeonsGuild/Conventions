...
public static class ClavusContextExtensions
{
    ...
    /// <returns></returns>
    public static ValueTask RegisterConventions(this IClavusContext context, Action<ConventionExecutor> configure)
    {
        ArgumentNullException.ThrowIfNull(context);
...
/// </remarks>
/// <param name="context"></param>
public class ConventionExecutor(IClavusContext context)
{
    /// <summary>
