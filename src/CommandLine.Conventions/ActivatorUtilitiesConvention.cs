...
namespace Rocket.Surgery.Conventions.CommandLine
{
    ...
    public class ActivatorUtilitiesConvention : McMaster.Extensions.CommandLineUtils.Conventions.IConvention
    {
        ...
        private async Task<int> OnExecute(McMaster.Extensions.CommandLineUtils.Conventions.ConventionContext context, CancellationToken cancellation)
        {
        ...
        /// <inheritdoc />
        public virtual void Apply([NotNull] McMaster.Extensions.CommandLineUtils.Conventions.ConventionContext context)
        {
            if (context == null)
            {
