...
public class TestWebAssemblyHost
{
    ...
    /// </summary>
    /// <returns></returns>
    public TestWebAssemblyHostBuilder Create()
    {
        return Create(_ => { });
    }
    ...
    /// <returns></returns>
    public TestWebAssemblyHostBuilder Create(Action<ConventionContextBuilder> action)
    {
        ...
        var reloadOnChange = builder.Configuration.GetValue("hostBuilder:reloadConfigOnChange", true);
        ...
        else
        {
            var config = new ConfigurationBuilder()
                        ...
                        .AddJsonFile($"appsettings.{env.Environment}.json", true, reloadOnChange)
                        .Build();
