...
/// </summary>
public class TestWebAssemblyHostBuilder : IWebAssemblyHostBuilder, IConventionContext
{
    ...
    internal TestWebAssemblyHostBuilder(IConventionContext conventionContext, string environmentName)
    {
        ...
        _createServiceProvider = () => Services.BuildServiceProvider(HostEnvironment.IsDevelopment());
    ...
    public T Parse<T>()
    {
        return _createServiceProvider().GetRequiredService<T>();
    }
